$(document).ready(function(){
	...
	$("#jd-chat .jd-online_user").click(function(){
		...
		$("#jd-chat").prepend('<div class="jd-user">\
			...
			<div class="jd-footer"><input id="place" placeholder="Escriba un mensaje"></div>\
		</div>');
	    //<a id="actualizar" style="cursor:pointer;font-size:12px" onclick="actualiza(' + id + ')"><center>Actualizar</center></a>
        ...
        setInterval(actualiza(id_usuario),2000);
