...
<div id="resultadopopup"> 

<div id="textopopup"> 

<span class="titulo1"><?php echo $conectado; ?></span>
...
if ( count($content) > 0 ) {
     foreach ( $content as $row ) {
      ...
      <a href="setprivadopopup.php?id_user='.$row2->msj_rem.'" target="ventana_iframe"><div id="chatset" class="step_box" ><span class="user">'.ucfirst($emisor). '</span><div class="user"></div></div></a>
         </div>';
...
<?php
echo '<div class="iframe-16-9"><iframe src="setprivadopopup.php?id_user='.$usuario_rem.'" name="ventana_iframe" width="300" height="500" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe></div>';
?>
</div>    
